...
const routes: Routes = [
    ...
    { path: "login/:page/:value", loadChildren: "./login/login.module#LoginModule" },
    ...
    { path: "comments/:id/:rate/:commentsCount", loadChildren: "./comments/comments.module#CommentsModule" },
